...
/**
* Object name: POSTRevenueScheduleByTransactionRatablyTypeRevenueEvent (POSTRevenueScheduleByTransactionRatablyTypeRevenueEvent)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "POSTRevenueScheduleByTransactionRatablyTypeRevenueEvent",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class POSTRevenueScheduleByTransactionRatablyTypeRevenueEvent extends BaseObject {
  /**
