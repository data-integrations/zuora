...
/**
* Object name: PaymentDebitMemoApplicationItemCreateRequestType (PaymentDebitMemoApplicationItemCreateRequestType)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PaymentDebitMemoApplicationItemCreateRequestType",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PaymentDebitMemoApplicationItemCreateRequestType extends BaseObject {
  /**
