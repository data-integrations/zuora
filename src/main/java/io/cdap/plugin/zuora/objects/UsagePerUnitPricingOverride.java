...
/**
* Object name: UsagePerUnitPricingOverride (UsagePerUnitPricingOverride)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "UsagePerUnitPricingOverride",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class UsagePerUnitPricingOverride extends BaseObject {
  /**
