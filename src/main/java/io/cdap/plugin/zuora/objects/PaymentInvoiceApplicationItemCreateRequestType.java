...
/**
* Object name: PaymentInvoiceApplicationItemCreateRequestType (PaymentInvoiceApplicationItemCreateRequestType)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PaymentInvoiceApplicationItemCreateRequestType",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PaymentInvoiceApplicationItemCreateRequestType extends BaseObject {
  /**
