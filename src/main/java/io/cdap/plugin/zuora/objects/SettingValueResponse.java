...
public class SettingValueResponse extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "SettingValueResponseErrorMessagesItem")
  ...
  **/
  ...
  public void addFields() {
    addCustomField("errorMessages", errorMessages, List.class);
