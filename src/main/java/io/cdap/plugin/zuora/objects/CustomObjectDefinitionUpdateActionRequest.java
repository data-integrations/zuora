...
/**
* Object name: CustomObjectDefinitionUpdateActionRequest (CustomObjectDefinitionUpdateActionRequest)
* Related objects: 
**/
...
public class CustomObjectDefinitionUpdateActionRequest extends BaseObject {
  ...
  **/
  ...
  /**
  * Name: relationship (relationship), Type: CustomObjectDefinitionUpdateActionRequestRelationshipItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
