...
@ObjectDefinition(
  Name = "PaymentDebitMemoApplicationUnapplyRequestType",
...
public class PaymentDebitMemoApplicationUnapplyRequestType extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "PaymentDebitMemoApplicationItemUnapplyRequestType")
  private List<PaymentDebitMemoApplicationItemUnapplyRequestType> items;
