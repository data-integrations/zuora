...
/**
* Object name: SoldToContactPostOrder (SoldToContactPostOrder)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "SoldToContactPostOrder",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class SoldToContactPostOrder extends BaseObject {
  /**
  ...
  **/
  ...
  public void addFields() {
    ...
    addCustomField("contactDescription", contactDescription, String.class);
