...
public class PUTOrderPatchRequestType extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "PUTOrderPatchRequestTypeSubscriptionsItem")
  private List<PUTOrderPatchRequestTypeSubscriptionsItem> subscriptions;
