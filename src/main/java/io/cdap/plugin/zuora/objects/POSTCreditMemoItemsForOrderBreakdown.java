...
@ObjectDefinition(
  Name = "POSTCreditMemoItemsForOrderBreakdown",
...
public class POSTCreditMemoItemsForOrderBreakdown extends BaseObject {
  ...
  **/
  @Nullable
  @SerializedName("memoItemIds")
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "POSTCreditMemoItemsForOrderBreakdownMemoItemIdsItem")
  ...
  **/
  ...
  public void addFields() {
    addCustomField("memoItemIds", memoItemIds, List.class);
