...
/**
* Object name: ChargeOverrideBillingItem (ChargeOverrideBillingItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "ChargeOverrideBillingItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class ChargeOverrideBillingItem extends BaseObject {
  /**
