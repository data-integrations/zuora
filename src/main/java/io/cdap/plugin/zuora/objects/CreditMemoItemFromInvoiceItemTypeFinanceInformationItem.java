...
/**
* Object name: CreditMemoItemFromInvoiceItemTypeFinanceInformationItem (CreditMemoItemFromInvoiceItemTypeFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CreditMemoItemFromInvoiceItemTypeFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CreditMemoItemFromInvoiceItemTypeFinanceInformationItem extends BaseObject {
  /**
