...
@ObjectDefinition(
  Name = "PUTOrderActionTriggerDatesRequestTypeSubscriptionsItem",
...
public class PUTOrderActionTriggerDatesRequestTypeSubscriptionsItem extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "PUTOrderActionTriggerDatesRequestTypeSubscriptionsItemOrderActionsItem")
