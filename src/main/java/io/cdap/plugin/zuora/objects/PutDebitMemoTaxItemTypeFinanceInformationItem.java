...
/**
* Object name: PutDebitMemoTaxItemTypeFinanceInformationItem (PutDebitMemoTaxItemTypeFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PutDebitMemoTaxItemTypeFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PutDebitMemoTaxItemTypeFinanceInformationItem extends BaseObject {
  /**
