...
/**
* Object name: AccountingPeriodWithoutSuccessTypeFileIdsItem (AccountingPeriodWithoutSuccessTypeFileIdsItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "AccountingPeriodWithoutSuccessTypeFileIdsItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class AccountingPeriodWithoutSuccessTypeFileIdsItem extends BaseObject {
  /**
  ...
  **/
  ...
  public void addFields() {
    addCustomField("accountsReceivableAccountAgingDetailExportFileId", accountsReceivableAccountAgingDetailExportFileId, String.class);
    addCustomField("accountsReceivableInvoiceAgingDetailExportFileId", accountsReceivableInvoiceAgingDetailExportFileId, String.class);
    addCustomField("arRollForwardDetailExportFileId", arRollForwardDetailExportFileId, String.class);
    addCustomField("fxRealizedGainAndLossDetailExportFileId", fxRealizedGainAndLossDetailExportFileId, String.class);
    addCustomField("fxUnrealizedGainAndLossDetailExportFileId", fxUnrealizedGainAndLossDetailExportFileId, String.class);
