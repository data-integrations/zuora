...
/**
* Object name: DebitMemoItemFromInvoiceItemTypeFinanceInformationItem (DebitMemoItemFromInvoiceItemTypeFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "DebitMemoItemFromInvoiceItemTypeFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class DebitMemoItemFromInvoiceItemTypeFinanceInformationItem extends BaseObject {
  /**
