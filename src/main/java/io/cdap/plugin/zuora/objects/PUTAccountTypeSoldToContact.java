...
/**
* Object name: PUTAccountTypeSoldToContact (PUTAccountTypeSoldToContact)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PUTAccountTypeSoldToContact",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PUTAccountTypeSoldToContact extends BaseObject {
  /**
