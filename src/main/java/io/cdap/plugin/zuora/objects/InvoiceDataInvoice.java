...
/**
* Object name: InvoiceDataInvoice (InvoiceDataInvoice)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "InvoiceDataInvoice",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class InvoiceDataInvoice extends BaseObject {
  /**
  ...
  **/
  ...
  public void addFields() {
    ...
    addCustomField("billRunId", billRunId, String.class);
    ...
    addCustomField("regenerateInvoicePDF", regenerateInvoicePDF, Boolean.class);
