...
/**
* Object name: PUTTaxationItemType (PUTTaxationItemType)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PUTTaxationItemType",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PUTTaxationItemType extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: financeInformation (financeInformation), Type: PUTTaxationItemTypeFinanceInformationItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
