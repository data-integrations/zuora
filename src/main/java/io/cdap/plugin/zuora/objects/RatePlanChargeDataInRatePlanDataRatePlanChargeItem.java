...
/**
* Object name: RatePlanChargeDataInRatePlanDataRatePlanChargeItem (RatePlanChargeDataInRatePlanDataRatePlanChargeItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "RatePlanChargeDataInRatePlanDataRatePlanChargeItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class RatePlanChargeDataInRatePlanDataRatePlanChargeItem extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: RolloverBalance (RolloverBalance), Type: number
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
  @SerializedName("rolloverBalance")
  @ObjectFieldDefinition(FieldType = Schema.Type.STRING)
  private String rolloverBalance;
  ...
  **/
  ...
  public void addFields() {
    ...
    addCustomField("rolloverBalance", rolloverBalance, String.class);
