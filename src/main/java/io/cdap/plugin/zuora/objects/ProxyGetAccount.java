...
/**
* Object name: ProxyGetAccount (ProxyGetAccount)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "ProxyGetAccount",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class ProxyGetAccount extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: CreditBalance (CreditBalance), Type: number
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
  ...
  **/
  ...
  /**
  * Name: TotalInvoiceBalance (TotalInvoiceBalance), Type: number
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
