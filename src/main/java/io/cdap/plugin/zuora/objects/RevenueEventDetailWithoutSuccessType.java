...
/**
* Object name: RevenueEventDetailWithoutSuccessType (RevenueEventDetailWithoutSuccessType)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "RevenueEventDetailWithoutSuccessType",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class RevenueEventDetailWithoutSuccessType extends BaseObject {
  /**
