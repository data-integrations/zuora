...
@ObjectDefinition(
  Name = "ProxyActionexecuteRequest",
...
public class ProxyActionexecuteRequest extends BaseObject {
  ...
  **/
  @Nullable
  @SerializedName("ids")
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "ProxyActionexecuteRequestIdsItem")
  ...
  **/
  ...
  public void addFields() {
    ...
    addCustomField("synchronous", synchronous, Boolean.class);
