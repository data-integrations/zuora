...
/**
* Object name: CreateSubscriptionTermsItemInitialTermItem (CreateSubscriptionTermsItemInitialTermItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CreateSubscriptionTermsItemInitialTermItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CreateSubscriptionTermsItemInitialTermItem extends BaseObject {
  /**
