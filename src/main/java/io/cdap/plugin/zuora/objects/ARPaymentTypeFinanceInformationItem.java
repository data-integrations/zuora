...
/**
* Object name: ARPaymentTypeFinanceInformationItem (ARPaymentTypeFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "ARPaymentTypeFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class ARPaymentTypeFinanceInformationItem extends BaseObject {
  /**
