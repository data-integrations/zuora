...
/**
* Object name: CreateOrderTermsAndConditions (CreateOrderTermsAndConditions)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CreateOrderTermsAndConditions",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CreateOrderTermsAndConditions extends BaseObject {
  /**
