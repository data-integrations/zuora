...
/**
* Object name: CreditMemoTypewithSuccess (CreditMemoTypewithSuccess)
* Related objects:
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CreditMemos",
  responseRootElement = "creditmemos",
  APIUrl = "creditmemos",
  ObjectType = ObjectDefinition.ObjectDefinitionType.BASE
)
public class CreditMemoTypewithSuccess extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: creditMemoDate (creditMemoDate), Type: string
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
