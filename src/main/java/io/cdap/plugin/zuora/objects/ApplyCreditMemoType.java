...
/**
* Object name: ApplyCreditMemoType (ApplyCreditMemoType)
* Related objects: 
**/
...
public class ApplyCreditMemoType extends BaseObject {
  /**
  * Name: debitMemos (debitMemos), Type: array|CreditMemoApplyDebitMemoRequestType
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
  @SerializedName("debitMemos")
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "CreditMemoApplyDebitMemoRequestType")
  ...
  **/
  ...
  /**
  * Name: invoices (invoices), Type: array|CreditMemoApplyInvoiceRequestType
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
  @SerializedName("invoices")
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "CreditMemoApplyInvoiceRequestType")
