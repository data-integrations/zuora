...
/**
* Object name: CreditMemoItemFromWriteOffInvoiceFinanceInformationItem (CreditMemoItemFromWriteOffInvoiceFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CreditMemoItemFromWriteOffInvoiceFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CreditMemoItemFromWriteOffInvoiceFinanceInformationItem extends BaseObject {
  /**
