...
/**
* Object name: ChargeOverrideForEvergreen (ChargeOverrideForEvergreen)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "ChargeOverrideForEvergreen",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class ChargeOverrideForEvergreen extends BaseObject {
  /**
  * Name: billing (billing), Type: ChargeOverrideForEvergreenBillingItem
  ...
  **/
  ...
  /**
  * Name: pricing (pricing), Type: ChargeOverrideForEvergreenPricingItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
