...
@ObjectDefinition(
  Name = "POSTPaymentMethodResponse",
  RequiredArguments = {
    "Request"
  },
...
public class POSTPaymentMethodResponse extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "POSTPaymentMethodResponseReasonsItem")
  private List<POSTPaymentMethodResponseReasonsItem> reasons;
