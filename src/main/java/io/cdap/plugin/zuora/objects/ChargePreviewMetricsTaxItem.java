...
/**
* Object name: ChargePreviewMetricsTaxItem (ChargePreviewMetricsTaxItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "ChargePreviewMetricsTaxItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class ChargePreviewMetricsTaxItem extends BaseObject {
  /**
