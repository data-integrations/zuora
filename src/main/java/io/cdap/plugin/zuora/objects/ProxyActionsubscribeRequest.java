...
@ObjectDefinition(
  Name = "ProxyActionsubscribeRequest",
...
public class ProxyActionsubscribeRequest extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "SubscribeRequest")
  private List<SubscribeRequest> subscribes;


  @Override
  public void addFields() {
    addCustomField("subscribes", subscribes, List.class);
  }
}
