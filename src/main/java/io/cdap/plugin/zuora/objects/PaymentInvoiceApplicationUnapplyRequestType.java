...
/**
* Object name: PaymentInvoiceApplicationUnapplyRequestType (PaymentInvoiceApplicationUnapplyRequestType)
* Related objects: 
**/
...
public class PaymentInvoiceApplicationUnapplyRequestType extends BaseObject {
  ...
  **/
  ...
  /**
  * Name: items (items), Type: array|PaymentInvoiceApplicationItemUnapplyRequestType
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
  @SerializedName("items")
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "PaymentInvoiceApplicationItemUnapplyRequestType")
