...
public class POSTInvoiceCollectResponseType extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "POSTInvoiceCollectCreditMemosType")
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "POSTInvoiceCollectInvoicesType")
