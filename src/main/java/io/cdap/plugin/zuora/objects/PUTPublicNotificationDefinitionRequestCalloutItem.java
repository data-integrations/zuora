...
/**
* Object name: PUTPublicNotificationDefinitionRequestCalloutItem (PUTPublicNotificationDefinitionRequestCalloutItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PUTPublicNotificationDefinitionRequestCalloutItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PUTPublicNotificationDefinitionRequestCalloutItem extends BaseObject {
  /**
