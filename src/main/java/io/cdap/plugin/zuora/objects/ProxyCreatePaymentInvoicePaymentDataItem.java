...
@ObjectDefinition(
  Name = "ProxyCreatePaymentInvoicePaymentDataItem",
...
public class ProxyCreatePaymentInvoicePaymentDataItem extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "InvoicePayment")
  private List<InvoicePayment> invoicePayment;


  @Override
  public void addFields() {
    addCustomField("invoicePayment", invoicePayment, List.class);
  }
}
