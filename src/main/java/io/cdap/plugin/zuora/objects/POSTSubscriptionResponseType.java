...
/**
* Object name: POSTSubscriptionResponseType (POSTSubscriptionResponseType)
* Related objects:
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "POSTSubscriptionResponseType",
  RequiredArguments = {
    "Request"
  },
...
public class POSTSubscriptionResponseType extends BaseObject {
  /**
