...
/**
* Object name: SubscribeRequestSubscriptionDataSubscription (SubscribeRequestSubscriptionDataSubscription)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "SubscribeRequestSubscriptionDataSubscription",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class SubscribeRequestSubscriptionDataSubscription extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: AncestorAccountId (AncestorAccountId), Type: string
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
  @SerializedName("ancestorAccountId")
  @ObjectFieldDefinition(FieldType = Schema.Type.STRING)
  private String ancestorAccountId;
  ...
  **/
  ...
  public void addFields() {
    ...
    addCustomField("ancestorAccountId", ancestorAccountId, String.class);
