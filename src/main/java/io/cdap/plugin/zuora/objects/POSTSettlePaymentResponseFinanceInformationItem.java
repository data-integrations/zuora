...
/**
* Object name: POSTSettlePaymentResponseFinanceInformationItem (POSTSettlePaymentResponseFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "POSTSettlePaymentResponseFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class POSTSettlePaymentResponseFinanceInformationItem extends BaseObject {
  /**
