...
/**
* Object name: CustomObjectCustomFieldDefinition (CustomObjectCustomFieldDefinition)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CustomObjectCustomFieldDefinition",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CustomObjectCustomFieldDefinition extends BaseObject {
  /**
