...
/**
* Object name: RefundObjectNSFields (RefundObjectNSFields)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "RefundObjectNSFields",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class RefundObjectNSFields extends BaseObject {
  /**
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.STRING)
  private String synctoNetSuite__NS;
  ...
  public void addFields() {
    ...
    addCustomField("synctoNetSuite__NS", synctoNetSuite__NS, String.class);
  }
}
