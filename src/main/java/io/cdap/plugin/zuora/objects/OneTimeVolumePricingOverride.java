...
/**
* Object name: OneTimeVolumePricingOverride (OneTimeVolumePricingOverride)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "OneTimeVolumePricingOverride",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class OneTimeVolumePricingOverride extends BaseObject {
  /**
