...
/**
* Object name: CreditMemoItemTypewithSuccessFinanceInformationItem (CreditMemoItemTypewithSuccessFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CreditMemoItemTypewithSuccessFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CreditMemoItemTypewithSuccessFinanceInformationItem extends BaseObject {
  /**
