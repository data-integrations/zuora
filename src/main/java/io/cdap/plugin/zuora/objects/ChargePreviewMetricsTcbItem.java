...
/**
* Object name: ChargePreviewMetricsTcbItem (ChargePreviewMetricsTcbItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "ChargePreviewMetricsTcbItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class ChargePreviewMetricsTcbItem extends BaseObject {
  /**
