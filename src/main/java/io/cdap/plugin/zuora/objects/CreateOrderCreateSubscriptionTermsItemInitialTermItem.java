...
/**
* Object name: CreateOrderCreateSubscriptionTermsItemInitialTermItem (CreateOrderCreateSubscriptionTermsItemInitialTermItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CreateOrderCreateSubscriptionTermsItemInitialTermItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CreateOrderCreateSubscriptionTermsItemInitialTermItem extends BaseObject {
  /**
