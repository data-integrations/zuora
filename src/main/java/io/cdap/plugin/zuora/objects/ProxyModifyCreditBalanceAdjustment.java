...
/**
* Object name: ProxyModifyCreditBalanceAdjustment (ProxyModifyCreditBalanceAdjustment)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "ProxyModifyCreditBalanceAdjustment",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class ProxyModifyCreditBalanceAdjustment extends BaseObject {
  /**
