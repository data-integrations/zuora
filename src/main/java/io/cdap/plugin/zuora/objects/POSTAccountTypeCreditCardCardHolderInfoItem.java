...
/**
* Object name: POSTAccountTypeCreditCardCardHolderInfoItem (POSTAccountTypeCreditCardCardHolderInfoItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "POSTAccountTypeCreditCardCardHolderInfoItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class POSTAccountTypeCreditCardCardHolderInfoItem extends BaseObject {
  /**
