...
/**
* Object name: PutDebitMemoTaxItemType (PutDebitMemoTaxItemType)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PutDebitMemoTaxItemType",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PutDebitMemoTaxItemType extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: financeInformation (financeInformation), Type: PutDebitMemoTaxItemTypeFinanceInformationItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
