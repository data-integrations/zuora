...
/**
* Object name: POSTTaxationItemForCMTypeFinanceInformationItem (POSTTaxationItemForCMTypeFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "POSTTaxationItemForCMTypeFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class POSTTaxationItemForCMTypeFinanceInformationItem extends BaseObject {
  /**
