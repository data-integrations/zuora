...
/**
* Object name: ARPaymentTypewithSuccessFinanceInformationItem (ARPaymentTypewithSuccessFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "ARPaymentTypewithSuccessFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class ARPaymentTypewithSuccessFinanceInformationItem extends BaseObject {
  /**
