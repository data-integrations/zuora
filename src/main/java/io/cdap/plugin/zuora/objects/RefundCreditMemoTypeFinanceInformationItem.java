...
/**
* Object name: RefundCreditMemoTypeFinanceInformationItem (RefundCreditMemoTypeFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "RefundCreditMemoTypeFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class RefundCreditMemoTypeFinanceInformationItem extends BaseObject {
  /**
