...
/**
* Object name: CMTaxItemTypeFinanceInformationItem (CMTaxItemTypeFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CMTaxItemTypeFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CMTaxItemTypeFinanceInformationItem extends BaseObject {
  /**
