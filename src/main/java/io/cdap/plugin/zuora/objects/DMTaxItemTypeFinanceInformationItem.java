...
/**
* Object name: DMTaxItemTypeFinanceInformationItem (DMTaxItemTypeFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "DMTaxItemTypeFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class DMTaxItemTypeFinanceInformationItem extends BaseObject {
  /**
