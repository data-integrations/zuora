...
/**
* Object name: SubscribeRequestBillToContact (SubscribeRequestBillToContact)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "SubscribeRequestBillToContact",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class SubscribeRequestBillToContact extends BaseObject {
  /**
