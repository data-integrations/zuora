...
/**
* Object name: DebitMemoApplicationPartType (DebitMemoApplicationPartType)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "DebitMemoApplicationPartType",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class DebitMemoApplicationPartType extends BaseObject {
  /**
