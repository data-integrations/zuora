...
@ObjectDefinition(
  Name = "PUTOrderActionTriggerDatesRequestTypeSubscriptionsItemOrderActionsItem",
...
public class PUTOrderActionTriggerDatesRequestTypeSubscriptionsItemOrderActionsItem extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "PUTOrderActionTriggerDatesRequestTypeSubscriptionsItemOrderActionsItemChargesItem")
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "PUTOrderActionTriggerDatesRequestTypeSubscriptionsItemOrderActionsItemTriggerDatesItem")
  private List<PUTOrderActionTriggerDatesRequestTypeSubscriptionsItemOrderActionsItemTriggerDatesItem> triggerDates;
