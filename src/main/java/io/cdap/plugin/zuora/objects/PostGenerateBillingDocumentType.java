...
public class PostGenerateBillingDocumentType extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "PostGenerateBillingDocumentTypeChargeTypeToExcludeItem")
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "PostGenerateBillingDocumentTypeSubscriptionIdsItem")
