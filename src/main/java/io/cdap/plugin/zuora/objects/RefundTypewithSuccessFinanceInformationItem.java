...
/**
* Object name: RefundTypewithSuccessFinanceInformationItem (RefundTypewithSuccessFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "RefundTypewithSuccessFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class RefundTypewithSuccessFinanceInformationItem extends BaseObject {
  /**
