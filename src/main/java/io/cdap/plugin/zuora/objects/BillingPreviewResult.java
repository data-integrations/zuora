...
public class BillingPreviewResult extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "POSTBillingPreviewCreditMemoItem")
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "POSTBillingPreviewInvoiceItem")
