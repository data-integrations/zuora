...
/**
* Object name: POSTRevenueScheduleByDateRangeTypeRevenueEvent (POSTRevenueScheduleByDateRangeTypeRevenueEvent)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "POSTRevenueScheduleByDateRangeTypeRevenueEvent",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class POSTRevenueScheduleByDateRangeTypeRevenueEvent extends BaseObject {
  /**
