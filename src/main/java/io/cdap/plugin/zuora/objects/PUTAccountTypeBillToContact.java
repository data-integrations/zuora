...
/**
* Object name: PUTAccountTypeBillToContact (PUTAccountTypeBillToContact)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PUTAccountTypeBillToContact",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PUTAccountTypeBillToContact extends BaseObject {
  /**
