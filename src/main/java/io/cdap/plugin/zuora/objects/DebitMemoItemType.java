...
/**
* Object name: DebitMemoItemType (DebitMemoItemType)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "DebitMemoItemType",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class DebitMemoItemType extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: financeInformation (financeInformation), Type: DebitMemoItemTypeFinanceInformationItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
  ...
  **/
  ...
  /**
  * Name: taxationItems (taxationItems), Type: DebitMemoItemTypeTaxationItemsItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
