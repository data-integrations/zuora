...
/**
* Object name: ProxyCreateProductRatePlanCharge (ProxyCreateProductRatePlanCharge)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "ProxyCreateProductRatePlanCharge",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class ProxyCreateProductRatePlanCharge extends BaseObject {
  /**
  ...
  **/
  ...
  public void addFields() {
    ...
    addCustomField("priceIncreaseOption", priceIncreaseOption, String.class);
