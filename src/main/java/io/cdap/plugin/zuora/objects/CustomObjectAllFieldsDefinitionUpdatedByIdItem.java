...
/**
* Object name: CustomObjectAllFieldsDefinitionUpdatedByIdItem (CustomObjectAllFieldsDefinitionUpdatedByIdItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CustomObjectAllFieldsDefinitionUpdatedByIdItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CustomObjectAllFieldsDefinitionUpdatedByIdItem extends BaseObject {
  /**
