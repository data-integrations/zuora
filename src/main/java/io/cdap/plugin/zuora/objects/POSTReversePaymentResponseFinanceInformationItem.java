...
/**
* Object name: POSTReversePaymentResponseFinanceInformationItem (POSTReversePaymentResponseFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "POSTReversePaymentResponseFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class POSTReversePaymentResponseFinanceInformationItem extends BaseObject {
  /**
