...
/**
* Object name: RSDetailWithoutSuccessType (RSDetailWithoutSuccessType)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "RSDetailWithoutSuccessType",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class RSDetailWithoutSuccessType extends BaseObject {
  /**
