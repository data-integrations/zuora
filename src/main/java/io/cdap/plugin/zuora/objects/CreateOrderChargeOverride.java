...
/**
* Object name: CreateOrderChargeOverride (CreateOrderChargeOverride)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CreateOrderChargeOverride",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CreateOrderChargeOverride extends BaseObject {
  /**
  * Name: billing (billing), Type: CreateOrderChargeOverrideBillingItem
  ...
  **/
  ...
  /**
  * Name: pricing (pricing), Type: CreateOrderChargeOverridePricingItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
