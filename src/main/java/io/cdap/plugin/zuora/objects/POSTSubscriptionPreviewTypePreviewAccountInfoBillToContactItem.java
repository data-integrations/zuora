...
/**
* Object name: POSTSubscriptionPreviewTypePreviewAccountInfoBillToContactItem (POSTSubscriptionPreviewTypePreviewAccountInfoBillToContactItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "POSTSubscriptionPreviewTypePreviewAccountInfoBillToContactItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class POSTSubscriptionPreviewTypePreviewAccountInfoBillToContactItem extends BaseObject {
  /**
