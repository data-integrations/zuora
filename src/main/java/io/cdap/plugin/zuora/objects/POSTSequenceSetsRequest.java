...
public class POSTSequenceSetsRequest extends BaseObject {
  ...
  **/
  @Nullable
  @SerializedName("sequenceSets")
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "POSTSequenceSetRequest")
  private List<POSTSequenceSetRequest> sequenceSets;


  @Override
  public void addFields() {
    addCustomField("sequenceSets", sequenceSets, List.class);
  }
}
