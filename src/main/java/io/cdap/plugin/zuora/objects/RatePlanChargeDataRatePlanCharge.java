...
/**
* Object name: RatePlanChargeDataRatePlanCharge (RatePlanChargeDataRatePlanCharge)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "RatePlanChargeDataRatePlanCharge",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class RatePlanChargeDataRatePlanCharge extends BaseObject {
  /**
