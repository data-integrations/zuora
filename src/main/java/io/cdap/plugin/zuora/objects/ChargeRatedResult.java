...
public class ChargeRatedResult extends BaseObject {
  ...
  **/
  @Nullable
  @SerializedName("ratedItems")
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "RatedItem")
  ...
  public void addFields() {
    ...
    addCustomField("ratedItems", ratedItems, List.class);
  }
}
