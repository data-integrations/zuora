...
/**
* Object name: CreditMemoApplyInvoiceItemRequestType (CreditMemoApplyInvoiceItemRequestType)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CreditMemoApplyInvoiceItemRequestType",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CreditMemoApplyInvoiceItemRequestType extends BaseObject {
  /**
