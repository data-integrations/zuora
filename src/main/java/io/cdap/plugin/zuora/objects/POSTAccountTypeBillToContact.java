...
/**
* Object name: POSTAccountTypeBillToContact (POSTAccountTypeBillToContact)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "POSTAccountTypeBillToContact",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class POSTAccountTypeBillToContact extends BaseObject {
  /**
