...
/**
* Object name: CreditMemoTaxItemFromInvoiceTaxItemType (CreditMemoTaxItemFromInvoiceTaxItemType)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CreditMemoTaxItemFromInvoiceTaxItemType",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CreditMemoTaxItemFromInvoiceTaxItemType extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: financeInformation (financeInformation), Type: CreditMemoTaxItemFromInvoiceTaxItemTypeFinanceInformationItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
