...
/**
* Object name: PreviewOrderChargeOverrideBillingItem (PreviewOrderChargeOverrideBillingItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PreviewOrderChargeOverrideBillingItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PreviewOrderChargeOverrideBillingItem extends BaseObject {
  /**
