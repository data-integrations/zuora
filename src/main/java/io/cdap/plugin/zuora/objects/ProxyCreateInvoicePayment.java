...
/**
* Object name: ProxyCreateInvoicePayment (ProxyCreateInvoicePayment)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "ProxyCreateInvoicePayment",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class ProxyCreateInvoicePayment extends BaseObject {
  /**
