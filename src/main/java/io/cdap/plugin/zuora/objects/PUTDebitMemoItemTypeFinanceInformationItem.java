...
/**
* Object name: PUTDebitMemoItemTypeFinanceInformationItem (PUTDebitMemoItemTypeFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PUTDebitMemoItemTypeFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PUTDebitMemoItemTypeFinanceInformationItem extends BaseObject {
  /**
