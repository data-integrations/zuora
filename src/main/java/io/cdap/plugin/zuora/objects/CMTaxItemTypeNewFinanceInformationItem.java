...
/**
* Object name: CMTaxItemTypeNewFinanceInformationItem (CMTaxItemTypeNewFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CMTaxItemTypeNewFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CMTaxItemTypeNewFinanceInformationItem extends BaseObject {
  /**
