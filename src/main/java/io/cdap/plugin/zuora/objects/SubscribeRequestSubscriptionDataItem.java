...
@ObjectDefinition(
  Name = "SubscribeRequestSubscriptionDataItem",
...
public class SubscribeRequestSubscriptionDataItem extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "RatePlanData")
  private List<RatePlanData> ratePlanData;


  @Override
  public void addFields() {
    addCustomField("ratePlanData", ratePlanData, List.class);
  }
}
