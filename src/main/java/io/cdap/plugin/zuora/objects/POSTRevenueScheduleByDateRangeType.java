...
/**
* Object name: POSTRevenueScheduleByDateRangeType (POSTRevenueScheduleByDateRangeType)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "POSTRevenueScheduleByDateRangeType",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class POSTRevenueScheduleByDateRangeType extends BaseObject {
  /**
