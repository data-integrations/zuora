...
/**
* Object name: ProxyCreateRefundGatewayOptionDataItem (ProxyCreateRefundGatewayOptionDataItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "ProxyCreateRefundGatewayOptionDataItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class ProxyCreateRefundGatewayOptionDataItem extends BaseObject {
  /**
