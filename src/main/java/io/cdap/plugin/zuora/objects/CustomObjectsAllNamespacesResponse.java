...
@ObjectDefinition(
  Name = "CustomObjectsAllNamespacesResponse",
...
public class CustomObjectsAllNamespacesResponse extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "CustomObjectsNamespace")
  private List<CustomObjectsNamespace> namespaces;


  @Override
  public void addFields() {
    addCustomField("count", count, Integer.class);
    addCustomField("namespaces", namespaces, List.class);
  }
}
