...
/**
* Object name: SubscribeRequestSoldToContact (SubscribeRequestSoldToContact)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "SubscribeRequestSoldToContact",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class SubscribeRequestSoldToContact extends BaseObject {
  /**
