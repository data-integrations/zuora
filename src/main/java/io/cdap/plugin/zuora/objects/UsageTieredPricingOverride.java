...
/**
* Object name: UsageTieredPricingOverride (UsageTieredPricingOverride)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "UsageTieredPricingOverride",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class UsageTieredPricingOverride extends BaseObject {
  /**
