...
@ObjectDefinition(
  Name = "PaymentInvoiceApplicationCreateRequestType",
...
public class PaymentInvoiceApplicationCreateRequestType extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "PaymentInvoiceApplicationItemCreateRequestType")
  private List<PaymentInvoiceApplicationItemCreateRequestType> items;
