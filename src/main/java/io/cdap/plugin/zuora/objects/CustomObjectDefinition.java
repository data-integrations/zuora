...
/**
* Object name: CustomObjectDefinition (CustomObjectDefinition)
* Related objects: 
**/
...
public class CustomObjectDefinition extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: schema (schema), Type: CustomObjectDefinitionSchemaItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
