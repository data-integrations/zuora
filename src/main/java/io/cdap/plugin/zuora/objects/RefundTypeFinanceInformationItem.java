...
/**
* Object name: RefundTypeFinanceInformationItem (RefundTypeFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "RefundTypeFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class RefundTypeFinanceInformationItem extends BaseObject {
  /**
