...
/**
* Object name: PutCreditMemoTaxItemType (PutCreditMemoTaxItemType)
* Related objects: 
**/
...
public class PutCreditMemoTaxItemType extends BaseObject {
  ...
  **/
  ...
  /**
  * Name: financeInformation (financeInformation), Type: PutCreditMemoTaxItemTypeFinanceInformationItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
