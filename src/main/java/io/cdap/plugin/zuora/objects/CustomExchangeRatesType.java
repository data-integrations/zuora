...
public class CustomExchangeRatesType extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "CustomExchangeRatesDataType")
  ...
  **/
  ...
  public void addFields() {
    addCustomField("inverse", inverse, Boolean.class);
    addCustomField("rates", rates, List.class);
