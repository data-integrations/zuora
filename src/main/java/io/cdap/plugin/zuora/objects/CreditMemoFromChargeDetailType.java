...
/**
* Object name: CreditMemoFromChargeDetailType (CreditMemoFromChargeDetailType)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CreditMemoFromChargeDetailType",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CreditMemoFromChargeDetailType extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: financeInformation (financeInformation), Type: CreditMemoFromChargeDetailTypeFinanceInformationItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
