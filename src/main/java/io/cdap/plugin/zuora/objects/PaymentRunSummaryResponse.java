...
public class PaymentRunSummaryResponse extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "PaymentRunSummaryTotalValues")
  private List<PaymentRunSummaryTotalValues> totalValues;


  @Override
  public void addFields() {
    addCustomField("numberOfCreditBalanceAdjustments", numberOfCreditBalanceAdjustments, Integer.class);
