...
/**
* Object name: PaymentMethodTypeCardHolderInfoItem (PaymentMethodTypeCardHolderInfoItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PaymentMethodTypeCardHolderInfoItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PaymentMethodTypeCardHolderInfoItem extends BaseObject {
  /**
