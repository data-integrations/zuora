...
/**
* Object name: Amendment (Amendment)
* Related objects: 
**/
...
public class Amendment extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: RatePlanData (RatePlanData), Type: AmendmentRatePlanDataItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
  @SerializedName("ratePlanData")
  @ObjectFieldDefinition(FieldType = Schema.Type.STRING)
  private String ratePlanData;
  ...
  **/
  ...
  public void addFields() {
    ...
    addCustomField("ratePlanData", ratePlanData, String.class);
