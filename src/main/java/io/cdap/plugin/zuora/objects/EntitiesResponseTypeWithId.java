...
/**
* Object name: EntitiesResponseTypeWithId (EntitiesResponseTypeWithId)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "EntitiesResponseTypeWithId",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class EntitiesResponseTypeWithId extends BaseObject {
  /**
