...
/**
* Object name: SubscribeRequestPreviewOptionsItem (SubscribeRequestPreviewOptionsItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "SubscribeRequestPreviewOptionsItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class SubscribeRequestPreviewOptionsItem extends BaseObject {
  /**
