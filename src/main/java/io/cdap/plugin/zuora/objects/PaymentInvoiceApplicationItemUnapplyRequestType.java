...
/**
* Object name: PaymentInvoiceApplicationItemUnapplyRequestType (PaymentInvoiceApplicationItemUnapplyRequestType)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PaymentInvoiceApplicationItemUnapplyRequestType",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PaymentInvoiceApplicationItemUnapplyRequestType extends BaseObject {
  /**
