...
public class PUTScheduleRIDetailType extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "RevenueScheduleItemType")
  private List<RevenueScheduleItemType> revenueItems;
