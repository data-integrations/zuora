...
@ObjectDefinition(
  Name = "POSTUsageRecordResponseType",
...
public class POSTUsageRecordResponseType extends BaseObject {
  ...
  **/
  @Nullable
  @SerializedName("data")
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "POSTUsageRecordResponseTypeDataItem")
  private List<POSTUsageRecordResponseTypeDataItem> data;
