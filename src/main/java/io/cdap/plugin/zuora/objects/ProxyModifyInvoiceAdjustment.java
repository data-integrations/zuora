...
/**
* Object name: ProxyModifyInvoiceAdjustment (ProxyModifyInvoiceAdjustment)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "ProxyModifyInvoiceAdjustment",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class ProxyModifyInvoiceAdjustment extends BaseObject {
  /**
