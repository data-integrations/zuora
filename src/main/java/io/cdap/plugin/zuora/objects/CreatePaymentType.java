...
public class CreatePaymentType extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "PaymentDebitMemoApplicationCreateRequestType")
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "PaymentInvoiceApplicationCreateRequestType")
