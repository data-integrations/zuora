...
/**
* Object name: PUTSubscriptionResponseTypeCreditMemoItem (PUTSubscriptionResponseTypeCreditMemoItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PUTSubscriptionResponseTypeCreditMemoItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PUTSubscriptionResponseTypeCreditMemoItem extends BaseObject {
  /**
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "POSTSubscriptionPreviewCreditMemoItemsType")
