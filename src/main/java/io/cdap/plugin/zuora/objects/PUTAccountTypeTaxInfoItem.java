...
/**
* Object name: PUTAccountTypeTaxInfoItem (PUTAccountTypeTaxInfoItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PUTAccountTypeTaxInfoItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PUTAccountTypeTaxInfoItem extends BaseObject {
  /**
