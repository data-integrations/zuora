...
/**
* Object name: AccountSummaryTypeSoldToContact (AccountSummaryTypeSoldToContact)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "AccountSummaryTypeSoldToContact",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class AccountSummaryTypeSoldToContact extends BaseObject {
  /**
