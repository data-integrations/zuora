...
/**
* Object name: TimeSlicedElpNetMetrics (TimeSlicedElpNetMetrics)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "TimeSlicedElpNetMetrics",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class TimeSlicedElpNetMetrics extends BaseObject {
  /**
