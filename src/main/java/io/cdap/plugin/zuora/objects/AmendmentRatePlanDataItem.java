...
@ObjectDefinition(
  Name = "AmendmentRatePlanDataItem",
...
public class AmendmentRatePlanDataItem extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "RatePlanChargeDataInRatePlanData")
  private List<RatePlanChargeDataInRatePlanData> ratePlanChargeData;
