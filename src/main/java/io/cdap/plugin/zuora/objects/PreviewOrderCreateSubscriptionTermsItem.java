...
/**
* Object name: PreviewOrderCreateSubscriptionTermsItem (PreviewOrderCreateSubscriptionTermsItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PreviewOrderCreateSubscriptionTermsItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PreviewOrderCreateSubscriptionTermsItem extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: initialTerm (initialTerm), Type: PreviewOrderCreateSubscriptionTermsItemInitialTermItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
