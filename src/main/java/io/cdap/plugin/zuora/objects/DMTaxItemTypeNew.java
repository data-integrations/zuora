...
/**
* Object name: DMTaxItemTypeNew (DMTaxItemTypeNew)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "DMTaxItemTypeNew",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class DMTaxItemTypeNew extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: financeInformation (financeInformation), Type: DMTaxItemTypeNewFinanceInformationItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
