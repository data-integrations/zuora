...
@ObjectDefinition(
  Name = "CreditMemoApplyInvoiceRequestType",
...
public class CreditMemoApplyInvoiceRequestType extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "CreditMemoApplyInvoiceItemRequestType")
  private List<CreditMemoApplyInvoiceItemRequestType> items;
