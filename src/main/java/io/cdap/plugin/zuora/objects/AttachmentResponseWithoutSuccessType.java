...
/**
* Object name: AttachmentResponseWithoutSuccessType (AttachmentResponseWithoutSuccessType)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "AttachmentResponseWithoutSuccessType",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class AttachmentResponseWithoutSuccessType extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: fileContentType (fileContentType), Type: string
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
