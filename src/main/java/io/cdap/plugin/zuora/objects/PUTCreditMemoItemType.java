...
/**
* Object name: PUTCreditMemoItemType (PUTCreditMemoItemType)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PUTCreditMemoItemType",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PUTCreditMemoItemType extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: financeInformation (financeInformation), Type: PUTCreditMemoItemTypeFinanceInformationItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
  ...
  **/
  ...
  /**
  * Name: taxItems (taxItems), Type: array|PutCreditMemoTaxItemType
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
  @SerializedName("taxItems")
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "PutCreditMemoTaxItemType")
  private List<PutCreditMemoTaxItemType> taxItems;
