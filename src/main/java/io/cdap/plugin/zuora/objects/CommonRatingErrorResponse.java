...
@ObjectDefinition(
  Name = "CommonRatingErrorResponse",
...
public class CommonRatingErrorResponse extends BaseObject {
  ...
  **/
  ...
  @ObjectFieldDefinition(FieldType = Schema.Type.ARRAY, NestedClass = "CommonRatingErrorResponseReasonsItem")
  private List<CommonRatingErrorResponseReasonsItem> reasons;
