...
/**
* Object name: CMTaxItemTypeNew (CMTaxItemTypeNew)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CMTaxItemTypeNew",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CMTaxItemTypeNew extends BaseObject {
  /**
  ...
  **/
  ...
  /**
  * Name: financeInformation (financeInformation), Type: CMTaxItemTypeNewFinanceInformationItem
  * Options (custom, update, select): false, false, false
  **/
  @Nullable
