...
/**
* Object name: PostRefundTypeFinanceInformationItem (PostRefundTypeFinanceInformationItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "PostRefundTypeFinanceInformationItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class PostRefundTypeFinanceInformationItem extends BaseObject {
  /**
