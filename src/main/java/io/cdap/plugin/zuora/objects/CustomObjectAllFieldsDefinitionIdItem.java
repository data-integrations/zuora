...
/**
* Object name: CustomObjectAllFieldsDefinitionIdItem (CustomObjectAllFieldsDefinitionIdItem)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "CustomObjectAllFieldsDefinitionIdItem",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class CustomObjectAllFieldsDefinitionIdItem extends BaseObject {
  /**
