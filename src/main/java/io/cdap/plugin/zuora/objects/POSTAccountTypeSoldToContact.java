...
/**
* Object name: POSTAccountTypeSoldToContact (POSTAccountTypeSoldToContact)
* Related objects: 
**/
@SuppressWarnings("unused")
@ObjectDefinition(
  Name = "POSTAccountTypeSoldToContact",
  ObjectType = ObjectDefinition.ObjectDefinitionType.NESTED
)
public class POSTAccountTypeSoldToContact extends BaseObject {
  /**
